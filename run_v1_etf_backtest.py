...
def run_v1_etf_backtest():
    ...
    # 保存结果
    output_dir = './results/v1_comprehensive_backtest'
    os.makedirs(output_dir, exist_ok=True)

    # 保存详细结果
    results_df = pd.DataFrame(results)
    results_file = os.path.join(output_dir, 'v1_comprehensive_backtest_results.csv')
...
if __name__ == '__main__':
    results_df = run_v1_etf_backtest()
