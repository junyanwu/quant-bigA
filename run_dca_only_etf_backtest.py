...
def run_dca_only_etf_backtest():
    """
    运行dca_only策略ETF回测
    """
    print("=" * 80)
    print("开始dca_only策略ETF回测")
    print("=" * 80)
...
if __name__ == '__main__':
    results_df = run_dca_only_etf_backtest()

    print("\n" + "=" * 80)
    print("dca_only策略ETF回测完成！")
    print("=" * 80)
