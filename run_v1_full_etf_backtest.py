...
def main():
    ...
    # 获取所有ETF文件
    etf_files = sorted(list(etf_dir.glob('*.csv')))
    print(f"找到 {len(etf_files)} 个ETF文件")
...
def generate_summary():
    ...
    生成v1策略的汇总CSV文件
    """
    results_dir = Path('./results/v1_results')
    output_file = Path('./results/v1_comprehensive_backtest/v1_comprehensive_backtest_results.csv')
